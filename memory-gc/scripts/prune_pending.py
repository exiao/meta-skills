...
USER_RULE_SCOPE_RE = re.compile(
    ...
    r'requires? (?:(?:user |my )?approval|(?:user |my )(?:permission|confirmation|consent))|'
    r'(?:get|need) (?:(?:user |my )?approval|(?:user |my )(?:permission|confirmation|consent))|'
    r'do not [^.]* without (?:asking (?:the )?(?:user|me)|'
    r'(?:user |my )?approval|(?:user |my )(?:permission|confirmation|consent)))\b'
)
